...
## [2026-07-10] ingest | ops 돈-흐름 비관여 경계 결정 — decisions/ops-no-money-flow 신설(허용: 타이머·등록·좌석·칩카운트·프라이즈 계산/표시 / 금지: 바이인 결제·시드권 발급·상금 지급 정산). 근거: 관광진흥법 2024-02 개정 카지노업 유사행위(7년 이하 징역), 2023~2026 단속 강화(2024-11 대회사+홀덤펍 29곳 169억 송치), WFP 상금 지급불능 사태, 국내 운영도구 무료배포 관행(와홀덤·포커스페이스). 함의: start.gg식 참가비 수수료 모델 채택 불가, 수익화는 구인자 대상 웹 전용 결제만. index 갱신(decisions 1). 출처: 2026-07-10 수익모델 리서치 세션(웹 조사) + ops_prizes 코드 검증(결제 연동 없음 확인)
