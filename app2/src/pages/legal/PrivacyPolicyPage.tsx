            ...
            {currentLanguage === 'ko' ? (
              <>
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    UNIQN(이하 "회사")은 다음의 목적을 위하여 개인정보를 수집 및 이용합니다. 수집된
                    개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며, 이용 목적이 변경될
                    시에는 사전 동의를 구할 것입니다.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 ml-4">
                        회원 탈퇴 시까지 (단, 관계 법령 위반에 따른 수사·조사 등이 진행 중인
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    회사는 원칙적으로 이용자의 개인정보를 제1조(개인정보의 수집 및 이용 목적)에서
                    명시한 범위 내에서만 처리하며, 이용자의 사전 동의 없이는 본래의 범위를 초과하여
                    처리하거나 제3자에게 제공하지 않습니다. 다만, 다음의 경우는 예외로 합니다:
                  </p>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    회사는 서비스 제공을 위해 아래와 같이 개인정보 처리 업무를 외부 전문업체에
                    위탁하여 운영하고 있습니다.
                  </p>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                    ...
                    개인정보보호책임자에게 서면, 전화, 이메일로 연락하시면 지체 없이 조치하겠습니다.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 ml-4">
                        이용자는 웹브라우저 상단의 도구 &gt; 인터넷 옵션 &gt; 개인정보 메뉴의 옵션
                        설정을 통해 쿠키 저장을 거부할 수 있습니다. 다만, 쿠키 설정을 거부할 경우
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    이 개인정보처리방침은 2025년 1월 1일부터 적용되며, 법령 및 방침에 따른
              ...
              <>
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    UNIQN (hereinafter referred to as "Company") collects and uses personal
                    information for the following purposes. The collected personal information will
                    not be used for purposes other than the following, and prior consent will be
                    obtained if the purpose of use changes.
                  </p>
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                      ...
                      <ul className="list-disc list-inside ml-4 space-y-1 text-gray-700 dark:text-gray-300">
                        ...
                        <li>
                          Prevention of unauthorized use and confirmation of intention to join
                        </li>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    ...
                    use period prescribed by law or the retention and use period consented to by the
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 ml-4">
                        Until membership withdrawal (however, if an investigation is in progress due
                        to violation of relevant laws, until the completion of the investigation)
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                        B. Retention in Accordance with Relevant Laws
                      </h3>
                      <ul className="list-disc list-inside ml-4 space-y-2 text-gray-700 dark:text-gray-300">
                        <li>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    In principle, the Company processes users' personal information only within the
                    scope specified in Article 1 (Purpose of Collection and Use of Personal
                    Information) and does not process beyond the original scope or provide it to
                    third parties without the user's prior consent. However, the following cases are
                    exceptions:
                  </p>
                  <ul className="list-disc list-inside ml-4 mt-4 space-y-2 text-gray-700 dark:text-gray-300">
                    <li>When the user has consented in advance</li>
                    <li>
                      When there is a request from an investigative agency according to procedures
                      and methods prescribed by law for investigative purposes
                    </li>
                  </ul>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    The Company outsources personal information processing tasks to external
                    specialized companies as follows to provide services.
                  </p>
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead className="bg-gray-50 dark:bg-gray-700">
                ...
                <section className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300 ml-4">
                        Information entered by users for membership registration is moved to a
                        separate DB (or separate file cabinet for paper) after the purpose is
                        achieved and stored for a certain period according to internal policies and
                        other relevant laws (refer to retention and use period) before being
                        destroyed.
                      </p>
                    </div>
                    <div>
                      ...
                      <ul className="list-disc list-inside ml-4 space-y-1 text-gray-700 dark:text-gray-300">
                        <li>
                          Electronic files: Deleted using technical methods that prevent record
                          reproduction
                        </li>
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-2 text-gray-700 dark:text-gray-300">
                    ...
                    <li>
                      Withdraw consent for collection, use, and provision of personal information
                    </li>
                  </ul>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                    Rights can be exercised directly through the settings menu in the service, and
                    if you contact the Personal Information Protection Officer in writing, by phone,
                    or by email, we will take action without delay.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    ...
                    be in charge of overall personal information processing tasks and to handle
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-2 text-gray-700 dark:text-gray-300">
                    <li>
                      ...
                      management plan, regular employee training
                    </li>
                    <li>
                      Technical measures: Access authority management for personal information
                      processing systems, installation of access control systems, encryption
                    </li>
                    <li>
                ...
                <section className="mb-8">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">
                    10. Installation, Operation, and Refusal of Automatic Personal Information
                    Collection Devices
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                    The Company uses 'cookies' that store usage information and retrieve it from
                    time to time to provide users with individually customized services.
                  </p>
                  <div className="space-y-4">
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                        B. Method to Refuse Cookie Settings
                      </h3>
                      <p className="text-gray-700 dark:text-gray-300 ml-4">
                        Users can refuse to store cookies through option settings in Tools &gt;
                        Internet Options &gt; Privacy menu at the top of the web browser. However,
                        refusing to set cookies may cause difficulties in using the service.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    This Privacy Policy is effective from January 1, 2025, and if there are
                    additions, deletions, or corrections to changes in accordance with laws and
                    policies, they will be notified through the notice section at least 7 days prior
