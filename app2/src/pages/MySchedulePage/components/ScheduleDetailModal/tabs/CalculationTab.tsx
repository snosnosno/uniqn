        ...
        <div className="space-y-2">
          {salaryInfo.allowances?.meal && salaryInfo.allowances.meal > 0 && (
            <div className="flex justify-between text-sm bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <span className="text-gray-900 dark:text-gray-100 font-medium">{salaryInfo.allowances.meal.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {salaryInfo.allowances?.transportation && salaryInfo.allowances.transportation > 0 && (
            <div className="flex justify-between text-sm bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <span className="text-gray-900 dark:text-gray-100 font-medium">{salaryInfo.allowances.transportation.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {salaryInfo.allowances?.accommodation && salaryInfo.allowances.accommodation > 0 && (
            <div className="flex justify-between text-sm bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <span className="text-gray-900 dark:text-gray-100 font-medium">{salaryInfo.allowances.accommodation.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {salaryInfo.allowances?.bonus && salaryInfo.allowances.bonus > 0 && (
            <div className="flex justify-between text-sm bg-gray-50 dark:bg-gray-700 rounded p-2">
              <span className="text-gray-600 dark:text-gray-300">보너스</span>
              <span className="text-gray-900 dark:text-gray-100 font-medium">{salaryInfo.allowances.bonus.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {salaryInfo.allowances?.other && salaryInfo.allowances.other > 0 && (
            <div className="flex justify-between text-sm bg-gray-50 dark:bg-gray-700 rounded p-2">
              <span className="text-gray-600 dark:text-gray-300">기타 수당</span>
              <span className="text-gray-900 dark:text-gray-100 font-medium">{salaryInfo.allowances.other.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {totalAllowances === 0 && (
        ...
        <div className="space-y-2">
          ...
          {salaryInfo.afterTaxAmount !== undefined && salaryInfo.afterTaxAmount > 0 && (
            <div className="flex justify-between">
              <span className="text-base font-medium text-green-700 dark:text-green-300">세후 급여</span>
