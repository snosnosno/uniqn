  ...
  if (errorProfile)
    return (
      <div className="p-6 text-center text-red-500 dark:text-red-400">
        {t('profilePage.error', { message: errorProfile.message })}
      </div>
    );
  if (!profile)
    return (
      <div className="p-6 text-center text-gray-900 dark:text-gray-100">
        {t('profilePage.viewProfileLogin')}
      </div>
    );
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="mt-1">
                <span className="text-lg text-gray-600 dark:text-gray-300">
                  {getNationalityDisplay(profile.nationality)}
                </span>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start mt-2">
                ...
                <span className="text-lg font-semibold text-gray-700 dark:text-gray-200">
                  {profile.rating?.toFixed(1) || t('common.notApplicable')}
                </span>
                <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">
                  ({profile.ratingCount || 0} {t('profilePage.ratings')})
                </span>
              </div>
            </div>
          ...
          {!isEditing || !isOwnProfile ? (
            <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
              <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4">
                {t('profilePage.profileDetails', '상세 정보')}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-gray-100">
                    {profile.phone || t('profilePage.notProvided')}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-gray-100">
                    {profile.age ? `${profile.age}세` : t('profilePage.notProvided')}
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-gray-600 dark:text-gray-400">
                  ...
                  <p className="text-gray-900 dark:text-gray-100">
                    {getRegionDisplay(profile.region)}
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-gray-600 dark:text-gray-400">
                  ...
                  <p className="text-gray-900 dark:text-gray-100">
                    {profile.experience || t('profilePage.notProvided')}
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="whitespace-pre-wrap text-gray-900 dark:text-gray-100">
                    {profile.history || t('profilePage.notProvided')}
                  </p>
                </div>
                <div className="md:col-span-2">
                  <p className="font-semibold text-gray-600 dark:text-gray-400">
                  ...
                  <p className="whitespace-pre-wrap text-gray-900 dark:text-gray-100">
                    {profile.notes || t('profilePage.notProvided', '없음')}
                  </p>
                </div>
                  ...
                  <div className="md:col-span-2 mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                    <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3">
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400 ml-2 font-normal">
                        {t(
                          'profilePage.privateInfoNote',
                          '(정산시 필요, 허가된 사람에게만 보입니다)'
                        )}
                      </span>
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                      <div>
                        <p className="font-semibold text-gray-600 dark:text-gray-400">
                          {t('profilePage.residentId')}
                        </p>
                        <p className="text-gray-900 dark:text-gray-100">
                          {profile.residentId || t('profilePage.notProvided')}
                        </p>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-600 dark:text-gray-400">
                        ...
                        <p className="text-gray-900 dark:text-gray-100">
                          {profile.bankName || t('profilePage.notProvided')}
                        </p>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-600 dark:text-gray-400">
                        ...
                        <p className="text-gray-900 dark:text-gray-100">
                          {profile.bankAccount || t('profilePage.notProvided')}
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    value={formData.name || ''}
                    readOnly
                    className="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                  />
                </div>
                <div>
                  <label
                ...
                <div>
                  ...
                  >
                    <option value="">
                      {t('profilePage.selectNationality', '국적을 선택하세요')}
                    </option>
                ...
                <div>
                  ...
                  <input
                    ...
                    name="gender"
                    id="gender"
                    value={genderDisplay(formData.gender)}
                    readOnly
                    className="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="">
                      {t('profilePage.selectExperience', '경력을 선택하세요')}
                    </option>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  type="submit"
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 dark:bg-indigo-700 hover:bg-indigo-700 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
