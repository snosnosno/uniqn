      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 dark:text-gray-400 mb-4 leading-relaxed">
              Smart platform for tournament management, staff management, and job postings all in
              one place. 효율적인 운영과 체계적인 관리로 더 나은 토너먼트 경험을 제공합니다.
            </p>
        ...
        <div className="border-t border-gray-800 dark:border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <span className="text-gray-500 dark:text-gray-600">버전 0.2.0</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 dark:border-gray-700">
          <div className="text-center text-gray-400 dark:text-gray-500 text-sm">
            <p className="mb-2">
              UNIQN improves tournament management efficiency through systematic management 더 나은
              게임 환경을 제공하는 것을 목표로 합니다.
            </p>
            <p>Enterprise 수준의 보안과 안정성을 바탕으로 안전한 서비스를 제공합니다.</p>
          </div>
        </div>
      </div>
    </footer>
