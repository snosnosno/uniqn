    ...
    return (
      <div className="w-full px-2 sm:px-4">
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
          <h2 className="text-xl font-bold text-yellow-800 dark:text-yellow-300 mb-2">관리 기능 제한</h2>
    ...
    return (
      <div className="w-full px-2 sm:px-4">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
          ...
          <p className="text-red-600 dark:text-red-400 mb-4">{error || '공고를 찾을 수 없습니다.'}</p>
          <button
            onClick={() => navigate('/app/admin/job-postings')}
            className="px-4 py-2 bg-red-600 dark:bg-red-700 text-white rounded hover:bg-red-700 dark:hover:bg-red-600"
          >
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex-1 text-center px-2 sm:px-4">
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-gray-100 truncate">{jobPosting.title}</h1>
            </div>
            
            <div className="flex items-center space-x-1 sm:space-x-3 flex-shrink-0">
              <span className={`px-2 sm:px-3 py-0.5 sm:py-1 text-xs sm:text-sm font-medium rounded-full ${
                jobPosting.status === 'open' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300'
              }`}>
