...
const BulkActionsModal: React.FC<BulkActionsModalProps> = ({
  ...
  const handleAction = async () => {
    ...
    try {
      ...
      logger.error('일괄 작업 오류:', error instanceof Error ? error : new Error(String(error)), {
  ...
  return (
    ...
    >
      {/* 선택된 스태프 개수 표시 */}
      <div className="mb-4">
        <p className="text-sm text-text-secondary">{selectedStaff.length}명의 스태프가 선택됨</p>
      </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-red-700 dark:text-red-400">
                        <p>
                          선택된 {selectedStaff.length}명의 스태프가 영구적으로 삭제됩니다. 이
                          작업은 되돌릴 수 없습니다.
                        </p>
                      </div>
                    </div>
