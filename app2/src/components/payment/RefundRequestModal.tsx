    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6">
          {/* 헤더 */}
          <div className="mb-4">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">환불 요청</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">주문번호: {orderId}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              환불 금액: {amount.toLocaleString()}
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={
                isLoading ||
                !selectedReason ||
                (selectedReason === 'other' && reason.trim().length < 10)
              }
