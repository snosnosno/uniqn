...
export const NotificationItem = memo<NotificationItemProps>(
  ({ notification, onClick, onMarkAsRead, onDelete, compact = false, className = '' }) => {
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p
                className={`text-sm ${notification.isRead ? 'text-gray-700 dark:text-gray-300' : 'font-semibold text-gray-900 dark:text-gray-100'}`}
              >
                {notification.title}
              </p>
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{getRelativeTime()}</p>
            </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-1">
              <h3
                className={`text-sm ${notification.isRead ? 'text-gray-700 dark:text-gray-300' : 'font-bold text-gray-900 dark:text-gray-100'}`}
              >
                {notification.title}
              </h3>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">{notification.body}</p>
