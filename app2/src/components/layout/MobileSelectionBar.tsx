      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button 
            ...
            className="flex items-center justify-center space-x-1 bg-red-600 dark:bg-red-700 text-white hover:bg-red-700 dark:hover:bg-red-600"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* 대량 선택 경고 */}
        {selectedCount > 100 && (
          <div className="bulk-selection-warning text-xs text-yellow-800 dark:text-yellow-200 flex items-start space-x-2">
