    ...
    >
      <div className={getToastStyles()}>
        <div className="flex items-start">
          ...
          <button
            onClick={handleClose}
            className="ml-2 flex-shrink-0 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
...
export const ToastContainer: React.FC = React.memo(() => {
  ...
  return (
    <div className="fixed z-50 space-y-2 max-w-md w-full px-4 bottom-4 left-1/2 -translate-x-1/2 safe-area-bottom">
      {toasts.map((toast) => (
