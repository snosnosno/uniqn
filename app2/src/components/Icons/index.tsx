...
export const TrophyIcon = ({ className = 'w-5 h-5', onClick }: IconProps) => (
  <svg className={className} fill="currentColor" viewBox="0 0 20 20" onClick={onClick}>
    <path
      fillRule="evenodd"
      d="M5 3a2 2 0 00-2 2v1c0 8.284 6.716 15 15 15h1a2 2 0 002-2v-3.5a2 2 0 00-2-2h-2.5c-.276 0-.5-.224-.5-.5v-2c0-.276.224-.5.5-.5h2.5a2 2 0 002-2V5a2 2 0 00-2-2H5zM9 9a1 1 0 011-1h1a1 1 0 110 2h-1a1 1 0 01-1-1z"
      clipRule="evenodd"
    />
  </svg>
);
