...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses = [
      ...
      'touch-manipulation',
      // Micro-interaction: active press effect
    ...
    const variantClasses = {
      primary: [
        ...
        isActive && 'bg-primary-700 dark:bg-primary-800',
      ],
      secondary: [
        ...
        isActive && 'bg-secondary-700 dark:bg-secondary-800',
      ],
      outline: [
      ...
      danger: [
        ...
        'focus:ring-red-500',
        'active:bg-red-800',
        isActive && 'bg-red-800 dark:bg-red-900',
      ],
      success: [
        ...
        'active:bg-green-800',
        isActive && 'bg-green-800 dark:bg-green-900',
      ],
      link: [
        ...
        isActive && 'text-blue-900 underline dark:text-blue-200',
      ],
    };
