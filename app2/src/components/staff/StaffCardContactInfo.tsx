  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-700">
      <div className="space-y-4">
        {/* 연락처 정보 */}
        <div>
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">연락처 정보</h4>
          {hasContactInfo ? (
              ...
              {phone && (
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">{phone}</span>
                  </div>
                  <a
                    href={`tel:${phone}`}
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">연락처 정보가 없습니다</p>
          )}
        </div>
      </div>
    </div>
