      ...
      {currentLanguage === 'en' && (
        <>
          ...
          <section className="mt-12 pt-8 border-t">
            ...
            <p className="text-gray-700">These Terms shall be effective from January 1, 2025.</p>
          </section>
        </>
      )}
    </div>
    ...
    <div className="prose prose-sm sm:prose max-w-none">
      ...
      {currentLanguage === 'ko' && (
        <>
          ...
          <section className="mt-12 pt-8 border-t">
            <h2 className="text-xl font-bold mb-4">부칙</h2>
            <p className="text-gray-700">본 개인정보처리방침은 2025년 1월 1일부터 시행됩니다.</p>
          </section>
        </>
      )}
      ...
      {currentLanguage === 'en' && (
        <>
          ...
          <section className="mt-12 pt-8 border-t">
            <h2 className="text-xl font-bold mb-4">Supplementary Provisions</h2>
            <p className="text-gray-700">This Privacy Policy shall be effective from January 1, 2025.</p>
          </section>
        </>
      )}
    </div>
