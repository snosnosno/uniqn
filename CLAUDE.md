...
- `components/common/AssignmentDisplay.tsx` - 통합 assignments 표시
...
- `useApplicantData.ts`에서 `assignments` 필드 누락 문제 수정
- AssignmentDisplay 컴포넌트 통합 및 UI 일관성 개선
- 불필요한 "그룹선택" 텍스트 라벨 제거, 시각적 표시는 유지
...
*마지막 업데이트: 2025년 9월 10일 (문서 정보 개발 단계 반영)*  
