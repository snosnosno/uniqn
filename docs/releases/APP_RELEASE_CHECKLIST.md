...
**버전**: v0.2.3 → v1.0.0 (플랫폼 전환 완료)
**최종 업데이트**: 2026년 2월 1일
**문서 상태**: 📁 **레거시 문서** (Capacitor 빌드, 개발 중단)

> ⚠️ **중요**: 이 체크리스트는 **app2/ (Capacitor 기반 레거시 웹앱)**용입니다.
> 현재 모바일앱은 **uniqn-mobile/** (React Native + Expo)로 전환되었습니다.
> 새 앱스토어 배포는 **EAS Build**를 사용합니다. 자세한 내용은 CLAUDE.md를 참조하세요.
