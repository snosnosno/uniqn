...
**최종 업데이트**: 2026년 2월 1일
**문서 상태**: 📁 **역사적 기록** (레거시 웹앱 마이그레이션)

> ⚠️ **레거시 문서 안내**: 이 문서는 **app2/ (레거시 웹앱)**의 v0.2.0 → v0.2.1 마이그레이션 기록입니다.
> 현재 주력 플랫폼인 **uniqn-mobile/** (React Native + Expo)과는 관련이 없습니다.
...
*원본 작성일: 2025년 9월 20일 (v0.2.1 마이그레이션)*