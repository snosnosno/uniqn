...
> 이 문서는 **계층·경계 수준의 개요**만 다룬다. 2026-06 이후 병합된 서브시스템
> (ops 대회운영엔진 #207~229 · 주간배치그리드 #219 · 공고 주문서 통합 #246~261 ·
> 팀 용어 통일 #282 · 지점 역할별 급여 JIT #311/#317 · ops 콘솔 리디자인 #313)의
> 세부는 `wiki/architecture/` 를 우선 확인하라.
