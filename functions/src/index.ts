...
export {
  onScheduleCreated,
  onScheduleCancelled,
} from "./notifications/onScheduleChanged";
...
export {
  ...
  forceDeleteAccount,
} from "./account/scheduledDeletion";
export {
...
} from "./scheduled/expireFixedPostings";
...
export const updateEventParticipantCount = onDocumentWritten(
  ...
  async (event) => {
    ...
    try {
      ...
      logger.info(
        `Updated participantCount for event ${eventId}: ${participantCount}`,
      );
    } catch (error) {
