 ...
 * (2) 성공 시 weeklyGrid prefix 무효화 + 스태프관리/공고 무효화 헬퍼를 호출하는지,
...
import { deleteSlot } from '@/services/weeklyGrid/gridWriteService';
...
describe('useDeleteSlot', () => {
  ...
  it('성공 시 weeklyGrid 일괄 무효화 + 스태프관리/공고 무효화 헬퍼 호출', async () => {
    mockDelete.mockResolvedValueOnce(undefined);
    const client = createClient();
