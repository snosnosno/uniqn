...
describe('jobPostingDocumentSchema', () => {
  ...
  it('should accept searchIndex generated by backend triggers', () => {
    const result = jobPostingDocumentSchema.safeParse({
      ...validDoc,
      searchIndex: ['dealer', 'seoul', 'gangnam'],
    });
    expect(result.success).toBe(true);
  });
...
describe('parseJobPostingDocument', () => {
  ...
  it('should parse document with backend searchIndex metadata', () => {
  ...
  it('should return null for valid-looking legacy document', () => {
    const result = parseJobPostingDocument(createValidLegacyJobPostingDocument());
    expect(result).toBeNull();
  });

  it('should return null for versioned pre-V3 legacy documents', () => {
    const result = parseJobPostingDocument({
  ...
  it('should return null for legacy string locations', () => {
    const result = parseJobPostingDocument({
      ...createValidLegacyJobPostingDocument(),
