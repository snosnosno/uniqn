  ...
  return (
    <Pressable
      ...
      className={`
        ...
        ${isActive ? 'bg-primary-600 dark:bg-primary-700' : 'bg-secondary-100 dark:bg-surface'}
      `}
                    ...
                    className={`
                      ...
                      ${
                        tempFilters.isUrgent
                          ...
                          : 'bg-secondary-50 dark:bg-surface border-secondary-200 dark:border-surface-overlay'
                      }
                    `}
                  >
