/**
 * UNIQN Mobile - Event QR panel (employer, presentation)
 *
 * @description EventQRModal 의 순수 표현 계층. 상태/이펙트는 useEventQRController 가 소유한다.
 */
...
import type { EventQRScope } from './eventQRScope';
import type { EventQRController, QRMode } from './useEventQRController';

const TOTAL_SECONDS = 180;

export type QRPanelProps = EventQRController & {
  jobTitle?: string;
  onClose: () => void;
};
  ...
  return (
    <View>
      ...
      <View className="items-center pb-4">
        ...
        <Card variant="filled" padding="md" className="w-full bg-primary-50 dark:bg-primary-900/20">
