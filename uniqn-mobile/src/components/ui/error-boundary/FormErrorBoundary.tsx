  ...
  return (
    <View className="p-4 bg-error-50 dark:bg-error-900/20 rounded-md border border-error-200 dark:border-error-800">
      ...
      <View className="flex-row gap-2">
        <Pressable
          onPress={onRetry}
          className="flex-1 bg-error-600 min-h-[44px] py-2.5 rounded-lg active:bg-error-700 items-center justify-center"
        ...
        <Pressable
          onPress={onReset}
          className="flex-1 bg-secondary-200 dark:bg-surface-elevated min-h-[44px] py-2.5 rounded-lg active:bg-secondary-300 dark:active:bg-secondary-600 items-center justify-center"
          accessibilityRole="button"
