...
export function InstallPromptContent({ description, onLogin }: InstallPromptContentProps) {
  return (
    <View className="items-center py-2">
      ...
      <Text className="text-center text-base font-sans-semibold text-secondary-900 dark:text-off-white">
        UNIQN 앱에서 계속 이용할 수 있어요
      </Text>

      <Text className="mt-3 text-center text-sm leading-6 text-secondary-500 dark:text-secondary-400 font-sans">
        {description}
      </Text>
