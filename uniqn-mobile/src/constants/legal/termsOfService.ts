...
export const TERMS_OF_SERVICE: LegalDocument = {
  ...
  sections: [
    {
      title: '제1조 (목적)',
      body: '이 약관은 스노스튜디오(이하 "회사")가 제공하는 UNIQN 서비스(이하 "서비스")의 이용조건 및 절차, 회사와 회원 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.',
    },
    {
      title: '제2조 (정의)',
      body:
    ...
    },
    {
      ...
      body:
        ...
        '- 사행성 도박, 불법 도박장 개설·운영, 금전을 건 배팅 중개를 목적으로 한 서비스 이용\n\n' +
        '2. 제한 절차\n' +
        '- 1차 위반: 경고\n' +
        '- 2차 위반: 7일 이용정지\n' +
        '- 3차 위반: 30일 이용정지\n' +
        ...
        '※ 사행성 도박, 불법 도박장 개설·운영, 금전 배팅 중개 목적의 이용이 확인된 경우 즉시 영구 이용정지하며, 관계기관에 통보할 수 있습니다.\n\n' +
        '3. 이의신청\n' +
