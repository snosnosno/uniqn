  ...
  sections: [
    {
      ...
      body:
        ...
        '4. 앱 내 채팅 이용 시\n' +
        '- 채팅 메시지 내용, 전송한 사진(촬영 위치 등 사진 속 부가정보는 앱과 서버에서 제거)\n' +
        '- 대화 상대·해당 공고, 메시지 발신·읽음 시각\n' +
        '- 차단·알림 설정, 신고 내용',
    },
    {
    ...
    },
    {
      ...
      body:
        ...
        '- 1년간 미이용 시 별도 분리 보관\n\n' +
        '4. 앱 내 채팅\n' +
        '- 대화 내용·사진: 마지막 메시지로부터 1년 후 파기\n' +
        "- 회원 탈퇴 시: 탈퇴자가 보낸 메시지 내용과 사진을 삭제하고 발신자를 '탈퇴한 사용자'로 표시\n" +
        '- 신고된 대화의 증거(신고 메시지와 직전 대화·사진): 신고 처리 완료 후 1년 보관 후 파기(분쟁 대응)',
    },
    {
