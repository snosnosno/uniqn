/**
 * UNIQN Mobile - 데이터베이스 필드명 상수
 *
 * @description Supabase 쿼리에 사용되는 필드명 중앙 관리
 * @version 2.0.0
 *
 * 사용 위치: Repository/Service의 .eq(), .order(), PostgREST 쿼리
 *
 * @example
 * import { FIELDS } from '@/constants';
 * query.eq(FIELDS.WORK_LOG.staffId, staffId)
 * query.order(FIELDS.COMMON.createdAt, { ascending: false })
 */
