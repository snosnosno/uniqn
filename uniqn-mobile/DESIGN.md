...
- **Text Primary:** #F0F0F2
- **Text Secondary:** #C4B898 (골드 틴트 — 보조 정보. 액센트 골드보다 뮤트.)
- **Text Muted:** #9A9078 (골드 틴트 — 플레이스홀더, 캡션. 더 뮤트.)
- **Text On Gold:** #09090B
- **Border:** #222228
...
- **Text Primary:** #09090B
- **Text Secondary:** #5C5546 (골드 틴트 — 다크모드와 톤 통일)
- **Text Muted:** #8A8272 (골드 틴트)
- **Border:** #D6D2CA
...
- 이모지 대신 Lucide 또는 Phosphor Icons 사용 권장
