...
export default function LiabilityWaiverScreen() {
  return (
    <SafeAreaView className="flex-1 bg-surface-page" edges={['top', 'bottom']}>
      ...
      >
        <Card className="mb-4">
          <Text className="mb-4 text-lg font-display text-content-primary">
            UNIQN 구인자 서약서
          </Text>

          <View className="mb-6 rounded-lg bg-warning-50 p-4 dark:bg-warning-900/20">
            <Text className="text-sm font-sans-medium leading-6 text-warning-800 dark:text-warning-200">
          ...
          <View className="mb-6 rounded-lg bg-error-50 p-4 dark:bg-error-900/20">
            <Text className="text-sm font-sans-medium leading-6 text-error-800 dark:text-error-200">
