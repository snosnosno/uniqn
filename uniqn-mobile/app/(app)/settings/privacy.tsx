...
export default function PrivacyScreen() {
  return (
    <SafeAreaView className="flex-1 bg-surface-page" edges={['top']}>
      <StackHeader title="개인정보처리방침" fallbackHref="/(app)/settings" />
      <ScrollView className="flex-1" contentContainerClassName="p-4">
        <Card className="mb-4">
          ...
          <Text className="mb-6 text-sm leading-6 text-content-muted dark:text-secondary-400 font-sans">
          ...
          <View className="border-t border-secondary-200 pt-4 dark:border-surface-overlay">
            <Text className="text-sm font-sans-medium text-content-secondary">부칙</Text>
