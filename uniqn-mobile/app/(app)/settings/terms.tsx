        ...
        <Card className="mb-4">
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              발생합니다.{'\n\n'}
              2. 회사는 필요한 경우 관련 법령을 위배하지 않는 범위에서 이 약관을 변경할 수
              있습니다.{'\n\n'}
              3. 약관 변경 시 시행일 7일 전부터 앱 내 공지사항을 통해 공지합니다.{'\n\n'}
              4. 회원의 권리 또는 의무에 중대한 변경이 있는 경우 시행일 30일 전부터 공지합니다.
              {'\n\n'}
              5. 회원이 변경된 약관에 동의하지 않는 경우 서비스 이용을 중단하고 탈퇴할 수
              있습니다.{'\n\n'}
              6. 변경된 약관의 시행일 이후에도 서비스를 계속 이용하는 경우 약관 변경에 동의한
              것으로 봅니다.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              3. 회원은 자신의 계정 정보를 안전하게 관리해야 하며, 제3자에게 이용을 허락해서는
              안 됩니다.{'\n\n'}
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              1. 회원 탈퇴{'\n'}
              - 회원은 언제든지 앱 내 "설정 {'>'} 계정관리 {'>'} 회원탈퇴" 메뉴를 통해 탈퇴를
              신청할 수 있습니다.{'\n'}
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              1. 회사는 관련 법령과 이 약관을 준수하며, 지속적이고 안정적으로 서비스를
              제공하기 위해 노력합니다.{'\n\n'}
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              {'\n\n'}
              3. 회사는 무료로 제공되는 서비스의 중단으로 인해 회원에게 발생한 손해에 대해
              책임지지 않습니다.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              1. 회사는 회사의 귀책사유로 인해 회원에게 손해가 발생한 경우, 그 손해를 배상할
              책임이 있습니다.{'\n\n'}
              2. 배상 범위{'\n'}
              - 직접적이고 현실적인 손해에 한함{'\n'}
              - 간접적, 부수적, 결과적 손해는 제외{'\n\n'}
              3. 회원이 본 약관을 위반하여 회사에 손해를 끼친 경우, 해당 회원은 회사에 그
              손해를 배상해야 합니다.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              1. 회사는 천재지변, 전쟁, 기간통신사업자의 서비스 중지 등 불가항력적 사유로
              서비스를 제공할 수 없는 경우 책임이 면제됩니다.{'\n\n'}
              2. 회사는 회원의 귀책사유로 인한 서비스 이용장애에 대해 책임지지 않습니다.{'\n\n'}
              3. 회사는 회원 간 또는 회원과 제3자 간에 서비스를 매개로 발생한 분쟁에 대해
              개입할 의무가 없으며, 이로 인한 손해를 배상할 책임도 없습니다.{'\n\n'}
              4. 회사는 무료로 제공하는 서비스 이용과 관련하여 회원에게 발생한 손해에 대해
              책임지지 않습니다. 단, 회사의 고의 또는 중과실로 인한 경우는 제외합니다.{'\n\n'}
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              3. 회원은 서비스를 이용하면서 얻은 정보를 회사의 사전 동의 없이 복제, 전송,
              출판, 배포, 방송 등의 방법으로 영리 목적으로 이용하거나 제3자에게 이용하게
              해서는 안 됩니다.{'\n\n'}
              4. 회사는 회원이 서비스 내에 게시한 콘텐츠를 서비스 운영, 개선, 홍보 등의
              목적으로 사용할 수 있습니다.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              ...
              2. 서비스 이용과 관련하여 회사와 회원 간에 분쟁이 발생한 경우, 쌍방은 분쟁해결을
              위해 성실히 협의합니다.{'\n\n'}
              3. 협의가 이루어지지 않을 경우, 다음 기관에 분쟁조정을 신청할 수 있습니다.{'\n'}
              - 한국인터넷진흥원 전자문서·전자거래분쟁조정위원회{'\n'}
              - 콘텐츠분쟁조정위원회{'\n\n'}
              4. 소송이 제기된 경우, 회사의 본사 소재지를 관할하는 법원을 전속 관할법원으로
              합니다.
            </Text>
          </View>
