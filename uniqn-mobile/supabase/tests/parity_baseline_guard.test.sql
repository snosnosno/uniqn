...
--     정책 111 불변(RPC 신설만, RLS 미변경).
--   2026-07-25 관리자 문의 응답 RPC(마이그 20260725150000, Sentry UNIQN-MOBILE-1N):
--     함수 180 = 178 + respond_inquiry 1 + update_inquiry_status 1
...
SELECT is(
  ...
  180,
  'public function count == prod (180 = 178 + 관리자 문의 응답 RPC 2, 2026-07-25)');
